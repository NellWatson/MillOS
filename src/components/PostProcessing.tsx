...
import { EffectComposer, Bloom, Vignette, ChromaticAberration, SSAO, Noise, ToneMapping, DepthOfField } from '@react-three/postprocessing';
...
export const PostProcessing: React.FC = () => {
  ...
  const hasAnyEffect = graphics.enableSSAO || graphics.enableBloom ||
    graphics.enableVignette || graphics.enableChromaticAberration ||
    graphics.enableFilmGrain || graphics.enableDepthOfField;
