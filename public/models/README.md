...
**The zero-texture stance was always worker-specific.** Those meshes stay
texture-free so skin, uniform, vest, hat and PPE variants can be applied at
runtime without duplicating texture memory. None of these 30 has a runtime
variant, and their surfaces *are* the asset - a Holstein assembled from boxes
